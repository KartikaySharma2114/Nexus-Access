    ...
    try {
      ...
      if (testCase.expectError) {
        ...
        const hasRequiredFields =
          ...
          (data.parsedCommand === null ||
            typeof data.parsedCommand === 'object');
        ...
        if (hasRequiredFields) {
          ...
          if (data.success && data.parsedCommand) {
            ...
            if (
              ...
              data.parsedCommand.type === testCase.expectedType
            ) {
              console.log('   ✓ Command type matches expected');
            } else if (testCase.expectedType) {
              console.log(
                `   ⚠ Expected ${testCase.expectedType}, got ${data.parsedCommand.type}`
              );
            }
